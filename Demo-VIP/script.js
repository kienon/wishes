...
// LIVE TOGETHER DAY COUNTER (Tukar tarikh mula di sini)
function startTogetherCounter() {
    const startDate = new Date("2023-01-01T00:00:00"); // Tarikh mula kenal / bercinta
    setInterval(() => {
        const now = new Date();
...
// BOUQUET, GALLERY, MUSIC & JAR LOGIC
